        ...
        <div>
            ...
            <p>get your own macropad!</p>
                    ...
                    <div>
                        ...
                        <p>
                            Hackpad is a You Ship, We Ship (YSWS) where you can
                            learn how to make your own macropad, and then we
                            ship <b className="font-bold">your</b> design to
                            you! Join <a>#hackpad</a> in the slack to stay up to
                            date and see what other people are working on!
                        </p>
                        <br></br>
                        <p>
                            A macropad is a small, minified keyboard that you
                            can program to do <i>anything</i> you want it to!
                            People mainly use them for shortcuts, custom
                            keybinds, typing whole sentences, and even a MIDI
                            controller! Some amazing examples:
                    ...
                    {/* <div>
                        ...
                        <p>
                            Here are some rules your design should follow! It's
                            not a comprehensive list, so if you have any
                            questions please ask in #hackpad in the slack!
                        </p>
                        <div className="md:flex justify-center inline-block sm:gap-40 pt-4 text-left border-">
                            <div>
                                <ul className="list-disc max-w-96 space-y-2 pb-2">
                                    <li>
                                        The overall design uses 16 or less
                                        inputs/switches. This includes rotary
                                        encoders!
                                    </li>

                                    <li>
                                        The PCB is under 100mm in either
                                        direction, and only uses 2 layers
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <ul className="list-disc max-w-96 space-y-2">
                                    ...
                                    <li>
                                        The macropad uses a through-hole Seeed
                                        XIAO RP2040 as its main MCU. No
                                        exceptions
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div>
                        <s>
                            ...
                            <p>
                                After making a macropad and getting approved,
                                you'll get to make an entire <b>keyboard</b>{" "}
                                after. Check the <a href="/faq">docs</a> to find
                                out more!
                            </p>
                        </s>
                    </div>
