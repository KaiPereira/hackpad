...
Shipping your project is the process of adding in all the final changes to make your project exist in the real world and off your computer! This includes:

- Structuring your project files, so that you ca
- Creating production files
- Creating a new GitHub Repository, so that you can share your files
- Adding a README.md file, wso that

And lastly, filling out the submission
...
<div className="bg-red-500 max-w-56 py-2 px-3 rounded-sm">
...
### After submitting
If everything went correctly, your submission will be reviewed (and hopefully approved!) by @alexren or another reviewer and you'll get a message on slack.

If it's approved, then you'll get:
- A hackpad kit with all the parts you need to build your hackpad, shipped from HQ.
- A $18 Card grant to buy a soldering iron, if requested.
- A $15 Card grant to buy your PCB + Get a 3D printed case from another Hack Clubber (check #printing-legion on slack if you need your case printed by someone else)!
