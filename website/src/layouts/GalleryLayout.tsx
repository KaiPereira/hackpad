    ...
    return (
        <div className="flex flex-col min-h-screen">
            <header className="bg-slate-100 text-white fixed top-0 z-10 w-full border-b-4 border-slate-500 border-dashed">
                <div>
                    <h1 className="text-2xl font-bold font-mono flex justify-between ml-4">
                        ...
                        />
                        <a
                            href="https://github.com/hackclub/hackpad"
                            target="_blank"
                        ...
                        >
                            <svg
                                ...
                                viewBox="0 0 496 512"
                                className="h-9 fill-current transition-all text-slate-950 hover:text-cyan-800 inline-block mb-2 mt-2.5 mr-8"
                            >
            ...
            <div className="flex flex-1 pt-16">
                ...
                <main className="flex-1 p-8 sm:ml-52">
                    {children}
                </main>
            </div>
        </div>
